 ...
 */
public final class FeathercoinIntegration
{
	private static final String INTENT_EXTRA_TRANSACTION_HASH = "transaction_hash";

	/**
	 * Request any amount of Feathercoins (probably a donation) from user, without feedback from the app.
	 * 
	 * @param context
	 *            Android context
	 * @param address
	...
	/**
	 * Request specific amount of Feathercoins from user, without feedback from the app.
	 * 
	 * @param context
	 *            Android context
	 * @param address
	 *            Feathercoin address
	 * @param amount
	 *            Feathercoin amount in nanocoins
	 */
	...
	/**
	 * Request any amount of Feathercoins (probably a donation) from user, with feedback from the app. Result intent can be
	 ...
	 * 
	 * Warning: A success indication is no guarantee! To be on the safe side, you must drive your own Feathercoin
	...
	/**
	 * Request specific amount of Feathercoins from user, with feedback from the app. Result intent can be received by
	...
	/**
	 * Put transaction hash into result intent. Meant for usage by Feathercoin wallet applications.
	 * 
	 * @param result
	 *            result intent
	 * @param txHash
	...
	/**
	 * Get transaction hash from result intent. Meant for usage by applications initiating a Feathercoin payment.
	 * 
	 * You can use this hash to request the transaction from the Feathercoin network, in order to validate. For this, you
	 * need your own Feathercoin infrastructure though. There is no guarantee that the transaction has ever been broadcasted
	 * to the Feathercoin network.
	 * 
	 * @param result
	 *            result intent
	...
	{
		final StringBuilder uri = new StringBuilder("feathercoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
